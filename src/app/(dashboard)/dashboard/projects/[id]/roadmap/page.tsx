            ...
            <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden relative">
                ...
                >
                    ...
                    {weeks.map((w) => (
                        <div
                            key={w}
                            className={`p-4 text-center border-r border-slate-100 last:border-0 ${w === currentWeek ? "bg-indigo-50/50" : ""
                                }`}
                        >
                            <span
                                className={`text-xs font-bold ${w <= currentWeek ? "text-slate-800" : "text-slate-400"
                                    }`}
                            >
                                W{w}
                            </span>
                    ...
                    {assignments?.map((item: any) => (
                        ...
                        >
                            ...
                            {weeks.map((w) => {
                                ...
                                const isCompleted =
                                    item.status === "completed" || w <= currentWeek; 
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`w-full h-8 rounded-lg shadow-sm flex items-center justify-center text-xs font-medium border transition-all duration-500 ${isCompleted
